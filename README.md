#Instructions
Your assignment is to create site as on image found in /source directory

It contains 3 files:

* image of finished work as a reference only *screenshot.jpg*
* text in that you can copy/paste
* an image that you can use
